  ...
  const [messages, setMessages] = useState([
    {
      id: "welcome-1",
      sender: "ai",
      text: "Hi there! I'm Trippi 🤖. Where are you planning to go?",
    ...
    <>
            ...
            <div className="flex items-center justify-between relative z-10">
              <div className="flex items-center gap-3">
                ...
                <div className="text-white">
                  <h3 className="font-bold text-lg leading-tight">TRIPPI AI</h3>
          ...
          <div className="flex-1 overflow-y-auto p-4 bg-[#f0f2f5] chat-scroll relative">
            ...
            <div className="space-y-4 relative z-10">
              ...
              {messages.map((msg) => (
                ...
                >
                  {/* AI SIDE — TRIPPI LABEL + AVATAR */}
                  {msg.sender === "ai" && (
                    <div className="flex flex-col items-start mr-2">

                      {/* MANU Name Label */}
                      <span className="text-[15px] font-semibold text-[#003EB5] mb-1 ml-1">
                        Trippi ✨
                      </span>

                      {/* Avatar */}
                      <div className="w-7 h-7 rounded-full bg-gradient-to-br from-[#003EB5] to-[#005CFF] 
                  ...
                  <div
                    className={`
        max-w-[75%] px-4 py-3 shadow-sm text-sm leading-relaxed relative
        ${msg.sender === "user"
      ...
      `}
                  >
                    ...
                    {/* Timestamp */}
                    <span
                      className={`text-[9px] absolute bottom-1 right-3 opacity-60 ${msg.sender === "user" ? "text-white" : "text-gray-400"
                        }`}
                    >
