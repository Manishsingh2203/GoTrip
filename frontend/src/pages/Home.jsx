        ...
        {["Maldives vacation", "Tokyo hotels", "Santorini sunset"].map((item, i) => (
          ...
          <section className="max-w-7xl mx-auto px-4 sm:px-6 py-12 md:py-20 bg-white">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
              {[
                { name: "Ahmedabad Flights", via: "Mumbai, Jaipur, Delhi, Hyderabad", image: "/popular/popular1.jpg" },
                { name: "Kochi Flights", via: "Bangalore, Chennai, Pune, Goa", image: "/popular/popular2.jpg" },
                { name: "Lucknow Flights", via: "Mumbai, Bangalore, Kolkata, Jaipur", image: "/popular/popular3.jpg" },
                { name: "Chandigarh Flights", via: "Delhi, Mumbai, Hyderabad, Pune", image: "/popular/popular4.jpg" },
                { name: "Patna Flights", via: "Kolkata, Delhi, Ranchi, Bangalore", image: "/popular/popular5.jpg" }
              ].map((route, index) => (
